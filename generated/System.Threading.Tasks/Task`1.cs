...
namespace System.Threading.Tasks
{
    public class Task<TResult> : Task
    {
        ...
        public Task<TResult> WaitAsync(TimeSpan timeout, TimeProvider timeProvider);
        public Task<TResult> WaitAsync(TimeSpan timeout, CancellationToken cancellationToken);
        public Task<TResult> WaitAsync(TimeSpan timeout, TimeProvider timeProvider, CancellationToken cancellationToken);
