...
namespace System.Runtime.Intrinsics.Wasm
{
    ...
    public abstract class PackedSimd
    {
        ...
        public static nint ExtractScalar(Vector128<nint> value, byte index);
        public static nuint ExtractScalar(Vector128<nuint> value, byte index);
        ...
        public static Vector128<nint> ReplaceScalar(Vector128<nint> vector, byte imm, nint value);
        public static Vector128<nuint> ReplaceScalar(Vector128<nuint> vector, byte imm, nuint value);
        ...
        public static Vector128<sbyte> LoadScalarAndInsert(sbyte* address, Vector128<sbyte> vector, byte index);
        public static Vector128<byte> LoadScalarAndInsert(byte* address, Vector128<byte> vector, byte index);
        public static Vector128<short> LoadScalarAndInsert(short* address, Vector128<short> vector, byte index);
        public static Vector128<ushort> LoadScalarAndInsert(ushort* address, Vector128<ushort> vector, byte index);
        public static Vector128<int> LoadScalarAndInsert(int* address, Vector128<int> vector, byte index);
        public static Vector128<uint> LoadScalarAndInsert(uint* address, Vector128<uint> vector, byte index);
        public static Vector128<long> LoadScalarAndInsert(long* address, Vector128<long> vector, byte index);
        public static Vector128<ulong> LoadScalarAndInsert(ulong* address, Vector128<ulong> vector, byte index);
        public static Vector128<float> LoadScalarAndInsert(float* address, Vector128<float> vector, byte index);
        public static Vector128<double> LoadScalarAndInsert(double* address, Vector128<double> vector, byte index);
        ...
        public static Vector128<short> LoadWideningVector128(sbyte* address);
        public static Vector128<ushort> LoadWideningVector128(byte* address);
        public static Vector128<int> LoadWideningVector128(short* address);
        public static Vector128<uint> LoadWideningVector128(ushort* address);
        public static Vector128<long> LoadWideningVector128(int* address);
        public static Vector128<ulong> LoadWideningVector128(uint* address);
        ...
        public static void StoreSelectedScalar(sbyte* address, Vector128<sbyte> source, byte index);
        public static void StoreSelectedScalar(byte* address, Vector128<byte> source, byte index);
        public static void StoreSelectedScalar(short* address, Vector128<short> source, byte index);
        public static void StoreSelectedScalar(ushort* address, Vector128<ushort> source, byte index);
        public static void StoreSelectedScalar(int* address, Vector128<int> source, byte index);
        public static void StoreSelectedScalar(uint* address, Vector128<uint> source, byte index);
        public static void StoreSelectedScalar(long* address, Vector128<long> source, byte index);
        public static void StoreSelectedScalar(ulong* address, Vector128<ulong> source, byte index);
        public static void StoreSelectedScalar(float* address, Vector128<float> source, byte index);
        public static void StoreSelectedScalar(double* address, Vector128<double> source, byte index);
