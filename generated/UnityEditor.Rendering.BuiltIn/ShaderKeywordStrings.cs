...
namespace UnityEditor.Rendering.BuiltIn
{
    public static class ShaderKeywordStrings
    {
        ...
        public static readonly string ReflectionProbeBlending;
        public static readonly string ReflectionProbeBoxProjection;
        public static readonly string SoftShadows;
        public static readonly string CastingPunctualLightShadow;
        ...
        public static readonly string DYNAMICLIGHTMAP_ON;
        public static readonly string _ALPHATEST_ON;
        public static readonly string DIRLIGHTMAP_COMBINED;
        public static readonly string EDITOR_VISUALIZATION;
    }
}
